...
```{r}
allBombusGressmark2018 <- getAllData(type = "bumblebees",
                        habitat = "gressmark",
                        year = 2018,
                        language = "norsk")
...
```{r}
allBombusSkogsmark2018 <- getAllData(type = "bumblebees",
                        habitat = "skogsmark",
                        year = 2018,
                        language = "norsk")
...
```{r}
allLepiSkogsmark2018 <- getAllData(type = "butterflies",
                        habitat = "skogsmark",
                        year = 2018,
                        language = "norsk")
...
```{r}
allLepiGressmark2018 <- getAllData(type = "butterflies",
                        habitat = "gressmark",
                        year = 2018,
                        language = "norsk")
